...
{
    /// <inheritdoc />
    public partial class Onlinerideshare : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReferredDriverId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ReferredCustomerName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ReferredCustomerPhone = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SourceLatitude = table.Column<float>(type: "real", nullable: true),
                    SourceLongitude = table.Column<float>(type: "real", nullable: true),
                    DestinationLatitude = table.Column<float>(type: "real", nullable: true),
                    DestinationLongitude = table.Column<float>(type: "real", nullable: true),
                    StartTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EndTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    TotalFare = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    IsPaid = table.Column<bool>(type: "bit", nullable: false),
                    DriverRating = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
